  ...
  return (
    ...
    >
      ...
      <header className="mb-12">
        ...
        <h2
          className="mt-2 font-display font-black uppercase text-4xl sm:text-5xl tracking-tight text-ink"
      ...
      <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
        ...
        <div className="lg:col-span-7 order-2 lg:order-1">
          ...
          <p className="font-body text-lg text-ink-2 leading-relaxed mb-6 max-w-2xl">
            ...
            Technology at Deggendorf Institute of Technology, Germany. I believe in closing the
            gap between complex theoretical modeling and practical, robust hardware deployments.
          </p>
          <p className="font-body text-lg text-ink-2 leading-relaxed mb-8 max-w-2xl">
            Currently leaning into{' '}
            <span className="text-ink font-semibold">Dynamic Control Methods</span> and building
            a solid foundation in{' '}
            <span className="text-ink font-semibold">Power Electronics</span>. Always open to
            connecting over embedded systems, control, or interesting hardware projects.
          </p>
          ...
          <div className="flex flex-wrap gap-2.5">
            {TAGS.map((tag) => (
              <span
                key={tag}
                className="font-mono text-xs uppercase tracking-[0.08em] px-3 py-1.5 border border-ink text-ink-2 hover:text-accent hover:border-accent transition-colors"
              >
                {tag}
              </span>
            ))}
          ...
          <div className="card-hard p-6">
            ...
            <ul className="flex flex-col">
              {FORWARD.map((it, i) => (
                <li
                  key={i}
                  className="group flex items-start gap-3 py-3 border-b border-hairline last:border-b-0 font-body text-ink-2"
                >
