...
const Contact = () => {
  ...
  const field =
    'w-full bg-paper border-2 border-ink px-4 py-3 font-body text-ink placeholder-ink-3 outline-none focus:border-accent transition-colors disabled:opacity-50';
          ...
          <div className="lg:col-span-5">
            ...
            <div className="border-t-2 border-ink">
              <a
                ...
                className="flex items-center gap-4 py-4 border-b border-hairline group"
              >
                <Mail className="w-5 h-5 shrink-0 text-accent" />
                <span className="font-mono text-sm text-ink group-hover:text-accent transition-colors min-w-0 truncate">
            ...
            <form onSubmit={handleSubmit} className="card-hard p-6 sm:p-8 flex flex-col gap-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  <label
                    htmlFor="name"
                    className="block font-mono text-xs uppercase tracking-[0.1em] text-ink-2 mb-2"
                  >
                    Your Name
                  </label>
                  <input
          ...
          <div className="mt-8 pt-6 border-t-2 border-ink flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-5">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1 font-mono text-xs uppercase tracking-[0.1em] text-ink hover:text-accent transition-colors"
              >
